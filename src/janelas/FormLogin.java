...
public class FormLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Controle de Produtividade");
        setResizable(false);
        ...
        usuarioTxt.getAccessibleContext().setAccessibleName("");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (Autenticacao.autorizado(user, pass) == true) {
                ...
                janelas.FormFormulario frm = new janelas.FormFormulario(user);
                frm.setVisible(true);
                this.dispose();
            ...
            java.util.logging.Logger.getLogger(FormLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null, "Erro 2: " + ex.toString());
        }
